...
PROFILE = default
PROJECT_NAME = ai_trend_analysis
...
fetch:
	$(PYTHON_INTERPRETER) ai_trend_analysis/fetch_data.py
	make sync_data_to_s3

## Sync raw from s3 and make Dataset
data: sync_data_from_s3
	$(PYTHON_INTERPRETER) ai_trend_analysis/make_dataset.py
...
lint:
	black ai_trend_analysis; flake8 ai_trend_analysis
